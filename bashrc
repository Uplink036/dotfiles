...
if [ "$color_prompt" = yes ]; then
    #Uncomment to get the normal view back, ps controls the name on the terminal 
...
case "$TERM" in
xterm*|rxvt*)
    # Apparently this sometimes kicks in, don't know why
...
alias sizeDir='du -s .'
alias cls='clear'
# Pretty csv, used for viewing csv files in the command line 
#
function pretty_csv 
{
